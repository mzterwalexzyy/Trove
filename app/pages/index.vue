  ...
  <div>
    <header class="flex items-center justify-between px-5 pt-5">
      <div class="flex items-center gap-2">
        <span class="flex size-8 items-center justify-center rounded-lg bg-gold/15">
          <svg viewBox="0 0 24 24" fill="currentColor" class="size-4 text-gold">
            <path d="m12 2 8.7 5v10L12 22l-8.7-5V7L12 2Z" />
          </svg>
        </span>
        <span class="text-[17px] font-bold tracking-tight">Nimiq Bounty</span>
      </div>
      <NuxtLink
        v-if="address"
        to="/me"
    ...
    <section class="mx-4 mt-4 overflow-hidden rounded-2xl bg-gradient-to-br from-[#efedff] to-[#e6f0ff] px-5 py-7">
